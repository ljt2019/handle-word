...
public class XWPFParagraphHandler {
    ...
    private void setXWPFRun() {
        ...
        //		System.out.println("设置XWPFRun相关的参数 = "+context.toString());
    }
    ...
    public boolean replaceAll(Map<String, String> param) {
        ...
        for (Entry<String, String> entry : entrys) {
            ...
            replaceSuccess =
                    replaceSuccess ? replaceSuccess : currSuccessReplace;
        }
        return replaceSuccess;
    }
    ...
    private boolean replace(String key, String value) {
        if (contains(key)) {
			 ...
			 */
            List<RunChar> addRunChar =
                new ArrayList<RunChar>();
    ...
    private void resetRunContext(List<RunChar> newRunChars) {
		 ...
		 */
        HashMap<XWPFRun, StringBuffer> newRunContext =
            new HashMap<XWPFRun, StringBuffer>();
        //重设context
        context = new StringBuffer();
